...
void HermesSynthAudioProcessorEditor::resized()
{
    ...
    osc.setBounds(paddingX, paddingY, width, height * 1.5f);
    osc2.setBounds(osc.getRight(), paddingY, width, height * 1.5f);
    adsr.setBounds(osc2.getRight(), paddingY, width, height * 1.5f);
