...
juce::AudioProcessorValueTreeState::ParameterLayout HermesSynthAudioProcessor::createParams()
{
    ...
    // OSC Waveform
    params.push_back(std::make_unique<juce::AudioParameterChoice>(juce::ParameterID { "OSC1WAVETYPE", 1 }, "Osc 1 Wave Type", juce::StringArray { "Sine", "Triangle", "Square", "Saw", "Noise", "Off" }, 0));
    params.push_back(std::make_unique<juce::AudioParameterChoice>(juce::ParameterID { "OSC2WAVETYPE", 1 }, "Osc 2 Wave Type", juce::StringArray { "Sine", "Triangle", "Square", "Saw", "Noise", "Off" }, 5));
    params.push_back(std::make_unique<juce::AudioParameterChoice>(juce::ParameterID { "OSC3WAVETYPE", 1 }, "Osc 3 Wave Type", juce::StringArray { "Sine", "Triangle", "Square", "Saw", "Noise", "Off" }, 5));
    ...
    params.push_back (std::make_unique<juce::AudioParameterFloat>(juce::ParameterID { "OSC3GAIN", 1 }, "Oscillator 3 Gain", juce::NormalisableRange<float> { -60.0f, 0.2f, 0.1f, 1.5f }, 0.1f, "dB"));
    ...
    params.push_back (std::make_unique<juce::AudioParameterInt>(juce::ParameterID { "OSC3PITCH", 1}, "Oscillator 3 Pitch", -48, 48, 0));
    ...
    params.push_back(std::make_unique<juce::AudioParameterFloat>(juce::ParameterID { "OSC1FMDEPTH", 1}, "Osc 1 FM Depth", juce::NormalisableRange<float> { 0.0f, 100.0f, 0.01f, 0.3f }, 0.0f));
    ...
    params.push_back(std::make_unique<juce::AudioParameterFloat>(juce::ParameterID { "OSC3FMFREQ", 1}, "Osc 3 FM Frequency", juce::NormalisableRange<float> { 0.0f, 1000.0f, 0.01f, 0.3f }, 0.0f));
    params.push_back(std::make_unique<juce::AudioParameterFloat>(juce::ParameterID { "OSC3FMDEPTH", 1}, "Osc 3 FM Depth", juce::NormalisableRange<float> { 0.0f, 100.0f, 0.01f, 0.3f }, 0.0f));
